        ...
        <div class="row">
            ...
            <div class="col-md-9 catalogue-col right mb-50">
                ...
                <div class="banner-wrap relative">
                    <?= Html::img("@web/img/category/{$category->img}" , ['alt' => $category->name ]) ?>
                    <div class="hero-holder text-center right-align">
                        <div class="hero-lines mb-0">
                            <h1 class="hero-heading white"><?= $category->name ?></h1>
                            <h4 class="hero-subheading white uppercase"><?= $category->description ?></h4>
                        </div>
                    </div>
                </div>
